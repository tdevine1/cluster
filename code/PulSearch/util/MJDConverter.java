...
public class MJDConverter
{
	...
	public static double toJulian(String ymd)
	{
		...
		int month = Integer.parseInt(ymd.substring(4, 6)); // jan=1, feb=2,...
		...
		return java.lang.Math.floor(julian - 2400000.5);
	}
