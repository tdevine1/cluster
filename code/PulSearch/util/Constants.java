...
{
	// public static final String GRANULARITY = "dpg";
	public static final String	GRANULARITY			= "singlepulse";
	public static final String	PLOT				= "peak";
	// public static final String MAIN_PATH = "F:\\AstroData\\";
	// public static final String MAIN_PATH = "F:\\Hal\\AstroData\\";
	// public static final String MAIN_PATH = "G:\\AstroData\\";
	public static final String	MAIN_PATH			= "G:\\Hal\\AstroData\\";
	...
	public static final String	DAT_PATH			= MAIN_PATH + "data"
			+ File.separator + SURVEY + File.separator + "dat" + File.separator;
	public static final String	CSV_PATH			= "A:\\AstroData\\" + "data"
			+ File.separator + SURVEY + File.separator + "csv" + File.separator;
